...
I spent an hour and could not get that shit to work, and I was starting to lose track of the actual problem I was trying to solve so I tweeted out looking for advice on the fastest way to just rent a real linux VM to get this done.
